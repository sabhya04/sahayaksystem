...
<body onload="$('#myCarousel').carousel()">
	<jsp:useBean id="sahayak" class="comm.Sahayak" scope="request"></jsp:useBean>
	<div class="wrap">
		<div class="header">
		...
		<div class="span12 well pass1">
			...
			<tr>
				<td>
					...
					<table class="table">
					<tr><td >Id : </td> <td style="text-transform:capitalize;">  <jsp:getProperty property="id" name="sahayak"/>  </td></tr>
					<tr><td >First Name : </td> <td style="text-transform:capitalize;">  <jsp:getProperty property="fname" name="sahayak"/>  </td></tr>
					<tr><td >Last Name : </td> <td style="text-transform:capitalize;">  <jsp:getProperty property="lname" name="sahayak"/>  </td></tr>
					<tr><td>E-Mail : </td> <td>  <jsp:getProperty property="email" name="sahayak"/>  </td></tr>
					<tr><td> Gender :</td> <td style="text-transform:capitalize;"> <jsp:getProperty property="gender" name="sahayak"/>   </td></tr>
					<tr><td>City : </td> <td style="text-transform:capitalize;">  <jsp:getProperty property="city" name="sahayak"/>  </td></tr>
			...
			<tr>
				<td>
				<span style="width:35%;"><a href="ForgetPasswordSahayak.html">Change Password</a></span>
